## kuka_robot_descriptions (humble) - 1.1.2-1

The packages in the `kuka_robot_descriptions` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble kuka_robot_descriptions` on `Mon, 20 Jul 2026 12:14:59 -0000`
...
## kuka_robot_descriptions (jazzy) - 2.0.2-1

The packages in the `kuka_robot_descriptions` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy kuka_robot_descriptions` on `Mon, 20 Jul 2026 11:46:21 -0000`
...
## kuka_robot_descriptions (humble) - 1.1.1-1

The packages in the `kuka_robot_descriptions` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble kuka_robot_descriptions` on `Mon, 20 Jul 2026 06:48:42 -0000`
...
## kuka_robot_descriptions (jazzy) - 2.0.0-1

The packages in the `kuka_robot_descriptions` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --new-track --rosdistro jazzy --track jazzy kuka_robot_descriptions` on `Wed, 15 Jul 2026 14:12:04 -0000`
...
## kuka_robot_descriptions (humble) - 1.1.0-1

The packages in the `kuka_robot_descriptions` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble kuka_robot_descriptions` on `Wed, 15 Jul 2026 09:24:44 -0000`
...
## kuka_robot_descriptions (humble) - 1.0.0-1
