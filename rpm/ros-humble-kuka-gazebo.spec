...
Name:           ros-humble-kuka-gazebo
Version:        1.1.2
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS kuka_gazebo package

License:        Apache-2.0
URL:            https://index.ros.org/p/kuka_gazebo/#humble
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-humble-controller-manager
Requires:       ros-humble-gz-ros2-control
...
Requires:       ros-humble-ros-gz-bridge
Requires:       ros-humble-ros-gz-sim
...
BuildRequires:  ros-humble-ros2run
%endif
